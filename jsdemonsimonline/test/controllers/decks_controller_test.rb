...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { cards: @deck.cards, name: @deck.name, runes: @deck.runes, user_id: @deck.user_id }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { cards: @deck.cards, name: @deck.name, runes: @deck.runes, user_id: @deck.user_id }
    assert_redirected_to deck_path(assigns(:deck))
  end
